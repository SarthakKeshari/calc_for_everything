      ...
      <BrowserRouter>
        <Routes>
          <Route path="/">
            ...
            {/* Computer Science */}
            <Route
              path="decbinandbindec"
              element={<MainDecToBinAndBinToDec />}
            />
            <Route
              path="hexbinandbinhex"
              element={<MainHexToBinAndBinToHex />}
            />
            <Route
              path="octbinandbinoct"
              element={<MainOctToBinAndBinToOct />}
            />
            <Route
              path="dechexandhexdec"
              element={<MainDecToHexAndHexToDec />}
            />
            <Route
              path="hexoctandocthex"
              element={<MainHexToOctAndOctToHex />}
            />
            <Route
              path="decoctandoctdec"
              element={<MainDecToOctAndOctToDec />}
            />
            <Route
              path="fracdecandDecfrac"
              element={<MainFracToDecAndDecToFrac />}
            />
            <Route
              path="asciitextbinAndbinasciitext"
              element={<MainAsciiTextToBinAndBinToAsciiText />}
            />
            ...
            <Route
              path="searchingvisualizer"
              element={<MainSearchingVisualizer />}
            />
            <Route
              path="sortingvisualizer"
              element={<MainSortingVisualizer />}
            />
            <Route
              path="mlmodelperformanceevaluationcalculator"
              element={<MainMLModelPerformanceEvaluationCalculator />}
            />
            <Route path="factorialcalc" element={<MainFactorialCalc />} />
            <Route
              path="infixtopostandprecalc"
              element={<MainInfixToPostAndPreCalc />}
            />
            <Route
              path="postandpretoinfixcalc"
              element={<MainPostAndPreToInfixCalc />}
            />
            <Route
              path="codetimecomplexitycalc"
              element={<MainCodeTimeComplexityCalc />}
            />
            <Route
              path="simpleonscreencalc"
              element={<MainSimpleOnScreenCalc />}
            />
            <Route path="advonscreencalc" element={<MainAdvOnScreenCalc />} />
            <Route path="formbuilder" element={<MainFormBuilder />} />
            <Route
              path="quespaperbuilder"
              element={<MainQuestionPaperBuilder />}
            />
            <Route
              path="codeeditorforwebdev"
              element={<MainCodeEditorWebDev />}
            />
            <Route path="ipv4toipv6calc" element={<MainIPv4ToIPv6Calc />} />
            <Route
              path="colorcodeformatconverter"
              element={<MainColorCodeFormatConverter />}
            />
            <Route
              path="dec2421codeconverter"
              element={<MainDec2421CodeConverter />}
            />
            <Route
              path="excess3codeconverter"
              element={<MainExcess3CodeConverter />}
            />
            <Route
              path="datastorageconverter"
              element={<MainDataStorageConverter />}
            />
            <Route
              path="hammingdistancecalc"
              element={<MainHammingDistance />}
            />
            <Route path="hammingcodecalc" element={<MainHammingCode />} />
            <Route
              path="filedatacomparator"
              element={<MainFileDataComparator />}
            />
            ...
            <Route
              ...
              element={<MainRandomNumberGenerator />}
            />
            ...
            <Route
              path="imagestopdfconsolidator"
              element={<MainImagesToPDFConsolidator />}
            />
            <Route
              path="computeralgebrasystemcascalc"
              element={<MainComputerAlgebraSystemCASCalc />}
            />
            <Route
              path="basechangecalc"
              element={<MainBaseChangeCalculator />}
            />
            ...
            <Route
              path="transmissiondelaycalc"
              element={<MainTransmissionDelayCalc />}
            />
            <Route
              path="carrollscaveofknowledgecalc"
              element={<MainCarrollsCaveOfKnowledge />}
            />
            <Route path="muxcalc" element={<MainMUXCalc />} />
            <Route
              path="propagationdelaycalc"
              element={<MainPropagationDelayCalc />}
            />
            ...
            <Route
              ...
              element={<MainBase64EncoderDecoder />}
            />
            {/* Mathematical */}
            ...
            <Route
              path="quadraticequationsolver"
              element={<MainQuadraticEquationSolver />}
            />
            ...
            <Route
              path="quadraticequationintersection"
              element={<MainQuadraticEquationIntersection />}
            />
            <Route
              path="linearequationintersection"
              element={<MainLinearEquationIntersection />}
            />
            <Route path="matrixaddition" element={<MainMatrixAddition />} />
            <Route
              path="matrixsubstraction"
              element={<MainMatrixSubstraction />}
            />
            <Route
              path="matrixmultiplication"
              element={<MainMatrixMultiplication />}
            />
            ...
            <Route
              path="matrixdeterminant"
              element={<MainMatrixDeterminant />}
            />
            <Route
              path="firstorderdifferentialeqsolver"
              element={<MainFirstOrderDifferentialEqSolver />}
            />
            <Route
              path="workandtimecalculator"
              element={<MainWorkAndTimeCalculator />}
            />
            <Route
              path="colinearpointsfinder"
              element={<MainCoLinearPointsFinder />}
            />
            <Route
              path="groupingpointsonsamesideofline"
              element={<MainPointsOnSameSideOfLineFinder />}
            />
            <Route
              path="groupingpointsoninsideoutsidequadraticcurve"
              element={<MainPointsInOnOutOfQuadCurveFinder />}
            />
            <Route
              path="polynomialeqdifferentialcalc"
              element={<MainPolynomialEqDifferentialCalc />}
            />
            <Route
              path="polynomialeqintegralcalc"
              element={<MainPolynomialEqIntegralCalc />}
            />
            <Route path="lcmcalc" element={<MainLCMCalc />} />
            <Route path="hcfcalc" element={<MainHCFCalc />} />
            <Route
              path="angletypeclassifier"
              element={<MainAngleTypeClassifier />}
            />
            <Route
              path="trignometricvaluecalc"
              element={<MainTrignometricValueCalc />}
            />
            ...
            <Route
              path="metricunitconverter"
              element={<MainMetricUnitConverter />}
            />
            <Route path="profitlosscalc" element={<MainProfitLossCalc />} />
            <Route path="distancecalc" element={<MainDistanceFormula />} />
            <Route
              path="bayesianprobabilitycalculator"
              element={<MainBayesianProbabilityCalculator />}
            />
            <Route
              path="triangletypefinder"
              element={<MainTriangleTypeFinder />}
            />
            <Route
              path="fractionsortingcalculator"
              element={<MainFractionSortingCalculator />}
            />
            <Route
              path="placeandfacevaluecalc"
              element={<MainPlaceAndFaceValueCalc />}
            />
            <Route
              path="equatingdenominatoroffraction"
              element={<MainEquatingDenominatorOfFraction />}
            />
            <Route path="tableofnumber" element={<MainTableOfNumber />} />
            <Route path="factorsofnumber" element={<MainFactorsOfNumber />} />
            <Route
              path="pythagorastheorem"
              element={<MainPythagorasTheorem />}
            />
            <Route
              path="mixedtoimproperanimpropertomixedfractioncalc"
              element={<MainMixedToImproperAndImproperToMixedFraction />}
            />
            <Route
              path="cuberootandsquarerootcalc"
              element={<MainCubeRootAndSquareRootCalc />}
            />
            <Route path="areaof2dshapes" element={<MainAreaOf2DShapes />} />
            <Route
              path="surfaceareaof3dshapes"
              element={<MainSurfaceAreaOf3DShapes />}
            />
            <Route
              path="squareandcubecalc"
              element={<MainSquareAndCubeCalc />}
            />
            <Route
              path="romannumeralconverter"
              element={<MainRomanNumeralConverter />}
            />
            <Route
              path="operationsonfractionscalc"
              element={<MainOperationsOnFractions />}
            />
            <Route
              path="statisticalgraphcreator"
              element={<MainStatisticalGraphCreator />}
            />
            <Route path="volume3dshapescalc" element={<MainVolume3DShapes />} />
            <Route
              path="congruencyoftrianglecalc"
              element={<MainCongruencyOfTriangleCalc />}
            />
            <Route
              path="numeralstowordsconverter"
              element={<MainNumeralsToWords />}
            />
            <Route
              path="permutationandcombinationcalc"
              element={<MainPermutationAndCombinationCalc />}
            />
            <Route
              path="similarityoftrianglecalc"
              element={<MainSimilarityOfTriangleCalc />}
            />
            ...
            <Route
              path="pipesandcisternscalc"
              element={<MainPipesAndCisternsCalc />}
            />
            <Route
              path="factorialcalcgamma"
              element={<MainFactorialCalc_Gamma />}
            />
            <Route
              path="analyticalFuncCalc"
              element={<MainAnalyticalFuncCalc />}
            />
            <Route path="zscorecalc" element={<MainZScoreCalc />} />
            <Route path="ztransformcalc" element={<MainZTransformCalc />} />
            <Route
              path="homogeneousinterpreter"
              element={<MainHomogeneousInterpreter />}
            />
            <Route
              path="variancestandarddeviationconverter"
              element={<MainVarianceStandardDeviationConverter />}
            />
            <Route
              path="statisticsmeancalc"
              element={<MainStatisticsMeanCalc />}
            />
            <Route
              path="statisticsmediancalc"
              element={<MainStatisticsMedianCalc />}
            />
            <Route path="rmsvaluecalc" element={<MainRMSValueCalc />} />
            <Route
              path="meandeviationaboutmediancalc"
              element={<MainMeanDeviationAboutMedianCalc />}
            />
            <Route
              path="coefofmeandeviationcalc"
              element={<MainCoefOfMeanDeviationCalc />}
            />
            <Route path="modecalc" element={<MainModeCalc />} />
            <Route
              path="setoperationsextendedcalc"
              element={<MainSetOperationsExtended />}
            />
            <Route
              path="universitygpacalc"
              element={<MainUniversityGPACalc />}
            />
            ...
            <Route
              path="chemicaleqbalancer"
              element={<MainChemicalEqBalancer />}
            />
            <Route
              path="chemicalkineticscalc"
              element={<MainChemicalKineticsCalc />}
            />
            <Route
              path="molecularweightcalc"
              element={<MainMolecularWeightCalc />}
            />
            <Route
              path="chemicalformulavalidator"
              element={<MainChemicalFormulaValidator />}
            />
            <Route
              path="empiricalformulacalc"
              element={<MainEmpiricalFormulaCalc />}
            />
            {/* Physics */}
            <Route path="pressurecalc" element={<MainPressureCalc />} />
            <Route
              path="cosmomassconverter"
              element={<MainCosmoMassConverter />}
            />
            <Route path="amplitudecalculator" element={<MainAmplitudeCalc />} />
            <Route
              path="vibrationalresponsecalc"
              element={<MainVibrationalResponseCalc />}
            />
            ...
            <Route
              path="combinedgaslawscalc"
              element={<MainCombinedGasLawsCalc />}
            />
            <Route
              path="kineticenergycalc"
              element={<MainKineticEnergyCalc />}
            />
            ...
            <Route
              path="multicurrencychangecalc"
              element={<MainMultiCurrencyChangeCalc />}
            />
            {/* Health */}
            ...
            <Route
              path="pregnancyduedatecalc"
              element={<MainPregnancyDueDateCalc />}
            />
            <Route path="drugdosagecalc" element={<MainDrugDosageCalc />} />
            <Route path="apgarscorecalc" element={<MainAPGARScoreCalc />} />
            <Route
              path="waterintakecalc"
              element={<MainWaterIntakeCalculator />}
            />
            <Route
              path="noveltyagecalc"
              element={<MainNoveltyAgeCalculator />}
            />
            ...
            <Route
              path="macronutrientratiocalc"
              element={<MainMacronutrientRatioCalc />}
            />
            {/* Art */}
            ...
            {/* Space */}
            <Route
              path="satellitelocationusingtle"
              element={<MainSatelliteLocationUsingTLE />}
            />
          </Route>
        </Routes>
      </BrowserRouter>
