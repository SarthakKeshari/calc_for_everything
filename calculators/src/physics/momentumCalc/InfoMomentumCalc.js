...
export default function InfoMomentumCalculator() {
      ...
      >
        ...
        <Box sx={style} sm={1}>
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            {/* Definition */}
            Momentum is a vector quantity that has both magnitude and direction. Since it has a direction, momentum can be used to estimate the end result of the direction and speed of motion of objects after they collide.
            <br/>
