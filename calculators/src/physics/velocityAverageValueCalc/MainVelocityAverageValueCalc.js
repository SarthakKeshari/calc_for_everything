...
import InfoVelocityAverageValueCalc from './InfoVelocityAverageValueCalc';
...
function MainVelocityAverageValueCalc() {
  ...
  function calculateAverageVelocity() {
    ...
    const velocity = Math.sqrt((8 * BoltzmannConstant * temp) / (PI*molecularWeight*mh));
    setAverageVelocity(velocity.toFixed(12));
    setError(false);
  }
  ...
  return (
    <Container maxWidth="lg" sx={{ bgcolor: '#eeeeee', minHeight: '90vh', paddingY: '10' }}>
      <Typography pt={1} variant="h5" sx={{ textAlign: 'center' }}>
        Velocity Average Value Calculator <InfoVelocityAverageValueCalc />
      </Typography>
      <hr />
      <br />
      ...
      <Container sx={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <Button
          variant="contained"
          onClick={calculateAverageVelocity}
...
export default MainVelocityAverageValueCalc;
