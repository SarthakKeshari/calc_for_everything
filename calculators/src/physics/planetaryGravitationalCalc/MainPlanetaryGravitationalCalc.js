...
// function MainPlanetaryGravitationalCalc(){
//     return(
//         <Container maxWidth="lg" sx={{ bgcolor: '#eeeeee', minHeight: '90vh', paddingY:"10" }}>
//             <Typography pt={1} variant='h5' sx = {{textAlign: "center"}}>Planetary Gravitational Calculator</Typography>
//             <hr/>
//             <br/>
...
// export default MainPlanetaryGravitationalCalc;
