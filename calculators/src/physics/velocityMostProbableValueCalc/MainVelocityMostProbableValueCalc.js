...
function MainVelocityMostProbableValueCalc() {
  ...
  const [mostProbableVelocity, setMostProbableVelocity] = useState('');
  ...
  function calculateMostProbableVelocity() {
    ...
    const velocity = Math.sqrt((2 * BoltzmannConstant * temp) / (molecularWeight*mh));
    setMostProbableVelocity(velocity.toFixed(12));
    setError(false);
  }
  ...
  return (
    <Container maxWidth="lg" sx={{ bgcolor: '#eeeeee', minHeight: '90vh', paddingY: '10' }}>
      <Typography pt={1} variant="h5" sx={{ textAlign: 'center' }}>
        Velocity Most Probable Value Calculator <InfoVelocityMostProbableValueCalc />
      </Typography>
      <hr />
      <br />
      ...
      <Container sx={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <Button
          variant="contained"
          onClick={calculateMostProbableVelocity}
