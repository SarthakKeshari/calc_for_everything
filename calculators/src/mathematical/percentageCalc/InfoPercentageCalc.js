...
export default function InfoPercentageCalc () {
      ...
      >
        ...
        <Box sx={style} sm={1}>
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            {/* Definition */}
            A percentage is a way to express a proportion or ratio as a fraction of 100, often represented by the "%" symbol.
            ...
            <code style={{display: 'flex', justifyContent: 'center'}}>
              <h5>
                ...
                "Percentage" represents the portion you want to express as a percentage.
"Part" is the specific portion or fraction of the whole you're interested in.
"Whole" is the complete or total quantity you're referring to.
