...
//     this.state = {
//       expression: '',
//       nthDerivative: 1, // Initialize to 1 by default
//       result: '',
//       isInvalidNthDerivative: false, // Flag for indicating an invalid nthDerivative
//     };
//   }
...
//     return (
//       <Paper style={appStyle} elevation={3}>
//         <Typography variant="h4">Derivative Calculator</Typography>
//         <TextField
//           type="text"
//           label="Enter expression (e.g., 3*x^2 + 2*x + 1)"
//           onChange={this.handleInputChange}
//           variant="outlined"
//           fullWidth
//           style={{ marginBottom: '20px', marginTop: '20px' }}
//           helperText="You can use standard mathematical notation. For example, 'cosec(x)' should be 'csc(x).'"
//         />
//         <TextField
//           type="number"
//           label="Nth Derivative"
...
//   handleNthDerivativeChange = (event) => {
//     const value = event.target.value;
//     this.setState({ nthDerivative: value });
//   }
...
//         <div style={{ marginTop: '20px' }}>
//           <Typography variant="h6">Expression: {this.state.expression}</Typography>
//           <Typography variant="h6" style={{ color: '#0000FF' }}>Derivative: {this.state.result}</Typography>
//         </div>
//       </Paper>
//     );
//   }
