...
export default function InfoLCMCalc() {
      ...
      >
        ...
        <Box sx={style} sm={1}>
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            {/* Definition */}
            The Lowest Common Multiple (LCM) of two or more integers is defined as the smallest positive integer that is divisible by each of the given integers without leaving a remainder.
            <br/>
            {/* Replace the below calculator name with yuor calculator name */}
            The formula for calculating LCM is:
            <br/>
            <code style={{display: 'flex', justifyContent: 'center'}}>
              <h3>
                {/* Add calc formula */}
                LCM(a, b) = (Prime factors common to a and b) × (Prime factors in a not common to b) × (Prime factors in b not common to a)
